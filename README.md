...
Il est possible de supprimer le buzzer en enlevant la goute d'étain qui sert de jumper, noté Buzz sur le PCB ! En plus des bits relatifs au protocole EM4100, le module entoure la chaine de caractères des codes 0x02 (Start of text) en début de chaine et 0x0A (CR), 0x0D (LF), 0x03 en fin de chaine.
